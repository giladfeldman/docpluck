...
# header-zone exemption and anything else that needs it. DOI grammar proper
...
# fixture that exposed the 2026-09-12 reference-DOI defect uses. A second
# copy of this concept WILL
# drift from this one, so derive from it rather than restating it.
_DOI_IDENTIFIER_IN_LINE = re.compile(
    r"(?:\b10\.\d{3,9}/[^\s]+|(?:doi\.org|dx\.doi\.org)/10/[a-zA-Z0-9]+)",
    re.IGNORECASE,
)
